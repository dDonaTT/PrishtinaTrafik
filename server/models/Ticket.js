...
const Ticket = {
  ...
  create: async ({
    ...
    const [result] = await db.query(
      `INSERT INTO tickets 
      (ticket_id, user_id, vehicle_id, vehicle_type, route_name, cost, qr_code, qr_secret, created_at) 
      VALUES (?,?,?,?,?,?,?,?, NOW())`,
      [ticket_id, user_id, vehicle_id, vehicle_type, route_name, cost, qr_code, qr_secret]
    );
